...
public:
    ...
    static const QString TYPE_WAYPOINT;
    static const QString TYPE_AIRPORT;
    static const QString TYPE_RUNWAY;
    static const QString TYPE_INTERSECTION;
    static const QString TYPE_NDB;
    static const QString TYPE_VOR;
    static const QString TYPE_ILS;
    static const QString TYPE_ALL;
    static const QString TYPE_HDG_TO_ALT;
    static const QString TYPE_HDG_TO_INTERCEPT;

    //TODO make flags enums!
    static const QString FLAG_ADEP;
    static const QString FLAG_SID;
    static const QString FLAG_SID_TRANS;
    static const QString FLAG_TOP_OF_CLIMB;
    static const QString FLAG_TOP_OF_DESCENT;
    static const QString FLAG_END_OF_DESCENT;
    static const QString FLAG_STAR;
    static const QString FLAG_APP_TRANS;
    static const QString FLAG_APPROACH;
    static const QString FLAG_ADES;
    static const QString FLAG_MISSED_APPROACH;
    static const QString FLAG_DISCONTINUITY;
    static const QString FLAG_DCT;
    ...
    void setTypeHdgToAlt() { m_type = TYPE_HDG_TO_ALT; }
    void setTypeHdgToIntc() { m_type = TYPE_HDG_TO_INTERCEPT; }
    ...
    bool hasViaId() { return !m_via_id.isEmpty(); }
    QString viaId() { return m_via_id; }
    void setViaId(QString value) { m_via_id = value; }
    ...
    void setHdgToHold(int hdg) { m_hdg_to_hold = hdg; }
    int hdgToHold() { return m_hdg_to_hold; }
